...
import com.pubmatic.rest.service.api.identity.PasswordChangedEvent;
 ...
 *
 */
public class ActivitiTokenBasedRememberMeServices extends TokenBasedRememberMeServices implements ApplicationListener<PasswordChangedEvent>{
  ...
  public ActivitiTokenBasedRememberMeServices(String key, UserDetailsService userDetailsService) {
